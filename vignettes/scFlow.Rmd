...
ctd_fp <- outputDir
download.file(url = "https://raw.githubusercontent.com/combiz/scFlowData/dev-nf/assets/ensembl_mappings_human.tsv", destfile = ensembl_fp)
download.file(url = "https://raw.githubusercontent.com/combiz/scFlowData/dev-nf/ctd/ctd_allAIBS.rds", destfile = file.path(ctd_fp, "ctd_allAIBS.rds"))
```
...
sce <- map_celltypes_sce(sce,
                         ctd_folder = ctd_fp, 
                         annotation_level = list("ctd_allAIBS" = c(1,2)),
                         label_index = 2)
```
