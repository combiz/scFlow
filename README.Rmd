...
See [this page on the wiki](https://github.com/combiz/scFlow/wiki/Installing-scFlow-from-a-private-github-repo) for a full explanation. For dependency related issues check this [link](https://github.com/combiz/scFlow/wiki).
