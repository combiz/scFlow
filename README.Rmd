...
Follow this [link](https://github.com/combiz/scflow/wiki/Installing-package-from-a-private-github-repo) for details. For dependecy related issues check this [link](https://github.com/combiz/scflow/wiki).
