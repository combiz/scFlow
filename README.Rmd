...
[![R build status](https://github.com/combiz/scFlow/workflows/R-CMD-check/badge.svg)](https://github.com/combiz/scFlow/actions)
<!-- badges: end -->
...
See [this page on the wiki](https://github.com/combiz/scFlow/wiki/Installing-scFlow-from-a-private-github-repo) for a full explanation. For dependecy related issues check this [link](https://github.com/combiz/scFlow/wiki).
...
matrix_fp <- paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "individual_1", sep = "")
samplesheet_fp <- paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "SampleSheet.tsv", sep = "") 
...
sce <- readRDS(paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "sce.rds", sep = ""))
```
...
```{r eval=TRUE, results="hide", include=FALSE}
sce_merged <- read_sce(
  paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "sce_merged", sep = "")
  )
```
...
```{r eval=TRUE, results="hide", include=FALSE}
result_de <- readRDS(
  paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "result_de.rds", sep = "")
  )
```
...
enrichment_result_webgestaltr <- readRDS(
  paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "res_webgestaltr.rds", sep = ""))

enrichment_result_rontotools <- readRDS(
  paste(system.file("extdata/vignette_data", package = "scFlowData"), "/", "res_rontotools.rds", sep = ""))
```
