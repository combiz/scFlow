...
```{r, fig.align="center", fig.width=6, fig.height=4, fig.cap = sprintf("<b>Figure: Doubletfinder parameter sweep for optimal pK.</b> An optimal pK value of %s was found at the BCmetric maxima.", metadata$doubletfinder_params$pK), eval=(metadata$scflow_steps$doubletfinder_sweep)}
