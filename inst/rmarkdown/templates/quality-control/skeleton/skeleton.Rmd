...
`r if(metadata$scflow_steps$singlets_annotated == 0){"No doublet/multiplet identification algorithm was run on this dataset."}`
...
```{r, fig.align = "center"}
datatable(metadata$qc_summary, colnames = "")
```
