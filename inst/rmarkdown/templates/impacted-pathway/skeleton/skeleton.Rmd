...
`r if(length(setdiff(names(metadata$ROntoTools), "metadata")) == 0){"No significant impacted pathways found at FDR <= 0.05!"}`
...
`r if(length(setdiff(names(metadata$enrichR), "metadata")) == 0){"No significant impacted pathways found at FDR <= 0.05!"}`
