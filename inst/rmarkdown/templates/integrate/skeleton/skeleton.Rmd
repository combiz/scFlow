---
title: "<b>scFlow</b> - Dataset Integration and Clustering Report"
...
bibliography: "`r system.file('bibtex/references.bib', package = 'scFlow')`"
---
...
<div class = "row">
<div class = "col-md-12">
```{r, fig.align="center", fig.width=30, fig.height=20,  fig.cap = "<b>Venn diagram of selected variable genes</b>. The bar numbers indicate how many variable genes are common between datasets. The datasets are represented by the numbers in the parentheses.", eval=length(metadata$dataset_integration$var.genes_per_dataset) < 11}
knitr::opts_chunk$set(echo = FALSE)
my_nv <- metadata$dataset_integration$var.genes_plots$venn
suppressWarnings(nVennR::showSVG(my_nv))
```
</div>
</div>
