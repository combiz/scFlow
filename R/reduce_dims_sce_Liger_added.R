...
#'
#' @param sce_merged a SingleCellExperiment object or merged SingleCellExperiment objects
...
#'
#' @return sce_merged SingleCellExperiment object annotated with reducedDims
#'
...
reduce_dims_sce <- function(sce_merged,
                            reduction_methods = c(
